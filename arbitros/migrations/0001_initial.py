...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Arbitro'
        db.create_table(u'arbitros_arbitro', (
        ...
        db.send_create_signal(u'arbitros', ['Arbitro'])


    def backwards(self, orm):
        # Deleting model 'Arbitro'
        db.delete_table(u'arbitros_arbitro')


    models = {
        u'arbitros.arbitro': {
            'Meta': {'object_name': 'Arbitro'},
