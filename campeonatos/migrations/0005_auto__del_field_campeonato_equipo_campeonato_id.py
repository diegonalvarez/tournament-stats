...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Campeonato_equipo.campeonato_id'
        db.delete_column(u'campeonatos_campeonato_equipo', 'campeonato_id_id')


    def backwards(self, orm):
        # Adding field 'Campeonato_equipo.campeonato_id'
        db.add_column(u'campeonatos_campeonato_equipo', 'campeonato_id',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=datetime.datetime(2014, 9, 16, 0, 0), to=orm['campeonatos.Campeonato'], unique=True),
                      keep_default=False)
