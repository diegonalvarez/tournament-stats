...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Campeonato'
        db.create_table(u'campeonatos_campeonato', (
            ...
            ('cantidad_equipos', self.gf('django.db.models.fields.IntegerField')(blank=True)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('complejo_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['complejos.Complejo'])),
        ))
        db.send_create_signal(u'campeonatos', ['Campeonato'])

        # Adding model 'Campeonato_equipo'
        db.create_table(u'campeonatos_campeonato_equipo', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('campeonato_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['campeonatos.Campeonato'])),
            ('equipo_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['equipos.Equipo'])),
        ))
        db.send_create_signal(u'campeonatos', ['Campeonato_equipo'])


    def backwards(self, orm):
        # Deleting model 'Campeonato'
        db.delete_table(u'campeonatos_campeonato')
    ...
    models = {
        ...
        u'campeonatos.campeonato_equipo': {
            ...
            'equipo_id': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['equipos.Equipo']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
