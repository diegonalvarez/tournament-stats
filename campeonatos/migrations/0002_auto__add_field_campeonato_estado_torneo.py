...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Campeonato.estado_torneo'
        db.add_column(u'campeonatos_campeonato', 'estado_torneo',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Campeonato.estado_torneo'
        db.delete_column(u'campeonatos_campeonato', 'estado_torneo')
