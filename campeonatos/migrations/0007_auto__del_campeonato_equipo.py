...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'Campeonato_equipo'
        db.delete_table(u'campeonatos_campeonato_equipo')

        # Removing M2M table for field equipo_id on 'Campeonato_equipo'
        db.delete_table('campeonatos_campeonato_equipo_equipo_id')

        # Adding M2M table for field equipos on 'Campeonato'
        db.create_table(u'campeonatos_campeonato_equipos', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('campeonato', models.ForeignKey(orm[u'campeonatos.campeonato'], null=False)),
            ('equipo', models.ForeignKey(orm[u'equipos.equipo'], null=False))
        ))
        db.create_unique(u'campeonatos_campeonato_equipos', ['campeonato_id', 'equipo_id'])


    def backwards(self, orm):
        # Adding model 'Campeonato_equipo'
        db.create_table(u'campeonatos_campeonato_equipo', (
            ('campeonato_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['campeonatos.Campeonato'], unique=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'campeonatos', ['Campeonato_equipo'])
        ...
        # Removing M2M table for field equipos on 'Campeonato'
        db.delete_table('campeonatos_campeonato_equipos')
    ...
    models = {
        ...
        u'campeonatos.campeonato': {
            ...
            'equipos': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['equipos.Equipo']", 'symmetrical': 'False', 'blank': 'True'}),
